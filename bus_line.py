...
pp.create_load(net, bus=b4, p_kw=100, q_kvar=50, name="Load1")
pp.create_load(net, bus=b5, p_kw=100, q_kvar=50, name="Load2")
pp.create_load(net, bus=b4, p_kw=100, q_kvar=50, name="Load3")
pp.create_load(net, bus=b6, p_kw=100, q_kvar=50, name="Load4")
